...
import {Button, Modal, Input, Upload, message, Popconfirm, Dropdown, Menu} from "antd";
...
class App extends React.Component {
    ...
    createNewFolder = () => {
        ...
        request.post("/api/folders/create", {
        ...
        return (
            <div className={"homeApp"}>
                <div className={"leftMenu"}>
                    <div>
                        <Button type={this.state.curMenuIndex === 0 ? "primary" : "default"} onClick={
                            event => {
                                this.setState({
                                    curMenuIndex:0,
                        ...
                        <Button type={this.state.curMenuIndex === 1 ? "primary" : "default"} onClick={
                            event => {
                                this.setState({
                                    curMenuIndex:1,
                        ...
                        <Button type={this.state.curMenuIndex === 3 ? "primary" : "default"} onClick={
                            event => {
                    ...
                    <br/><br/><br/>
                    <img src={require("../assets/recycleBin.png").default} alt={""} onClick={
                        event => {
                            message.info("To be developed");
                        }
                    } />
                    ...
                    <div className={"body"}>
                        <div className={"curDirectory"}>
                            ...
                            {this.state.curDirectory !== "/" &&
                                <img className={"return"} src={require("../assets/return.png").default} alt={""} onClick={
                                    () => {
                                        this.setState({
                                            curDirectory: this.state.curDirectory.substring(0, this.state.curDirectory.lastIndexOf("/") + 1)
                                        }, function () {
                                            this.getMyFiles();
                                        })
                                    }
                        ...
                        {this.state.files.map((file,index) => (
                            <Dropdown
                                    ...
                                    <Menu>
                                        ...
                                        {file.type === "file" &&
                                            <Menu.Item key={"download"}>
                                                <a href={"/files"+this.state.curDirectory + file.name}>Download</a>
                                            </Menu.Item>}
                                    </Menu>
                                }>
                                <Button type={"link"} onClick={
                                    ...
                                    <img src={require("../assets/"+file.type+".png").default} alt={""}/>
                                    {file.name}
                                </Button>
                            </Dropdown>
                        ))}
                ...
                <Modal
                    ...
                    centered={true}
                    width={"300px"}>
                    <Input value={this.state.newFolderName}
                           maxLength={20}
                           ref={(input) => { this.inputNewFolderName = input; }}
                           onChange={
                               event => {
